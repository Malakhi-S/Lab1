...
```
    ...
    ##  C:\Users\Administrator.KJLWS11\AppData\Local\Temp\RtmpO45g2r\downloaded_packages
...
![](README_files/figure-gfm/cougar3-1.png)<!-- -->
...
![](README_files/figure-gfm/cougar4-1.png)<!-- -->
...
![](README_files/figure-gfm/cougar7-1.png)<!-- -->
...
![](README_files/figure-gfm/cougar8-1.png)<!-- -->
...
![](README_files/figure-gfm/cougar9-1.png)<!-- --> Clearly these data
are still not normal, and so it might be useful to think of categorizing
...
![](README_files/figure-gfm/cougarLogit2-1.png)<!-- -->
...
![](README_files/figure-gfm/cougarLogit2-2.png)<!-- -->
...
![](README_files/figure-gfm/obj2-1.png)<!-- -->

``` r
plot(wolfyht_terra)
```

![](README_files/figure-gfm/obj2-2.png)<!-- -->
...
![](README_files/figure-gfm/obj2-3.png)<!-- -->
...
![](README_files/figure-gfm/obj4-1.png)<!-- -->
...
![](README_files/figure-gfm/obj6-1.png)<!-- -->
