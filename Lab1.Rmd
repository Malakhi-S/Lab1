...
elc_habitat_sf <- st_read("Data/elc_habitat.shp") #can also use read_sf() - the functions do the same thing except st_read prints
...
# look at raster data -- not sure how to do this one with terra/sf
data(deer_w)
